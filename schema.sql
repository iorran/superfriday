...
CREATE TABLE IF NOT EXISTS invoices (
  file_key TEXT PRIMARY KEY,           -- Blob storage file key (e.g., "1764586862873-invoice.pdf")
...
CREATE TABLE IF NOT EXISTS email_templates (
  id TEXT PRIMARY KEY,
  name TEXT NOT NULL,                  -- Template name (e.g., "Invoice to Client", "Invoice to Account Manager")
